...
const AppHeader: React.FC = () => {
    ...
    return (
        <header className="sticky top-0 z-50 flex w-full border-gray-200 bg-[#def0fc] transition-all duration-300 ease-in-out lg:border-b dark:border-gray-800">
                    ...
                    {/* <div className="hidden lg:block">
                        <form>
                            <div className="relative">
                                ...
                                <button
                                    className="absolute top-1/2 right-2.5 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-1.75 py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 dark:border-gray-800 dark:bg-white/3 dark:text-gray-400"
